 ...
 */
export class MyTableDataSource extends DataSource<FinalResponse> {
  data: FinalResponse[] = fakeresponseData;
   ...
   */
  connect(): Observable<FinalResponse[]> {
   ...
   */
  private getPagedData(data: FinalResponse[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: FinalResponse[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'name': return compare(a.claimId, b.claimId, isAsc);
        case 'id': return compare(+a.ProviderLastName, +b.ProviderLastName, isAsc);
        default: return 0;
      }
    });
  }
